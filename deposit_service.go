...
// 	r := &request{
// 		method:   "POST",
// 		endpoint: "/wapi/v3/getDepositHistory.html",
...
// // DepositAddressService get deposit wallets
...
// // Status set status
// func (s *DepositAddressService) Status(status int) *DepositAddressService {
// 	s.status = &status
// 	return s
// }

// // StartTime set startTime
// func (s *DepositAddressService) Timestamp(timestamp int64) *DepositAddressService {
